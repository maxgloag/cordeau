...
final class Version20260514134725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Composite index : findAllForUser filtre par proprietaire_id ET trie par nom → tri couvert par l'index.
        $this->addSql('CREATE INDEX idx_client_proprietaire_nom ON client (proprietaire_id, nom)');
